<a href="https://stackblitz.com/github/Hansanghyeon/twin.macro-boilerplate/next-emotion-typescript">
  <img
...
```shell
npx degit https://github.com/hansanghyeon/boilerplate/twin-next-emotion-typescript folder-name
```
