<a href="https://stackblitz.com/github/Hansanghyeon/twin.macro-boilerplate/next-styled-components">
  <img
...
```shell
npx degit https://github.com/hansanghyeon/boilerplate/twin-next-styled-components folder-name
```
