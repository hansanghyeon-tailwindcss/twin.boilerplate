<a href="https://stackblitz.com/github/Hansanghyeon/twin.macro-boilerplate/vite-styled-components-typescript">
  <img
...
```shell
npx degit https://github.com/hansanghyeon/boilerplate/twin-vite-styled-components-typescript folder-name
```
